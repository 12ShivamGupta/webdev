...
// get id of selected team
		var catid=$(this).find(':selected').val();
                ...
                // set json url
		var json_url="getsubcategoryjson1?catid="+catid;
            ...
            <div class="box-panel">
              ...
              <form action="registerExpert" method="get">
                ...
                <div class="form-group">
                  <label>Email</label>
                  <input required="required" type="text" placeholder="Expert's Email ID" name="id" class="form-control">
                </div>
                 <div class="form-group">
...
new ClassPathXmlApplicationContext("spring.xml");
                            ...
                            if(lst != null)
                            {
                                ...
                                {
                                	List<QuestionSubCategory> slist = qd.getQuestionSubCategoriesByQuestionCategory(obj.getId());
                                	
                                	List<String> lsp = new ArrayList<String>();
                                	
                                	if(slist!=null)
                                	{
                                		for(QuestionSubCategory obj1 : slist)
                            			{
                                			Expert rf = qd.getExpertByCatSubCat(obj.getId(), obj1.getId());
                                			boolean b = lsp.contains(obj.getCategoryName());
                                			if(!b)
                                			{
                                			  if(rf==null) 
                            				  {
                 ...
                 <div class="form-group">
                  ...
                  <select required="required" id="subcat" class="questions-category form-control" name="subCategoryID">
